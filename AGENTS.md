...
AI agent instructions for KDE customizations. This is based on instructions designed for Python, so adapt it accordingly to KDE's QML (i.e., Qt Meta-object Language).

<!-- NOTE: Based on .github/copilot-instructions.md -->
<!-- TODO: keep in sync with Mezcla version -->
