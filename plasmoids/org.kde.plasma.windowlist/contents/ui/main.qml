...
Item {
    ...
    Component.onCompleted: {
       console.warn("TPO windowlist/main.qml url=", Qt.resolvedUrl("main.qml"));
       // TODO: implicitHeight = PlasmaCore.Units.roundToIconSize(parent.height)
       implicitHeight = -1
       console.warn("TPO WindowList sizes: height=", windowListView.height,
